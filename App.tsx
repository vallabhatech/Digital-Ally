...
const DashboardPage: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8 pt-20 w-full max-w-7xl mx-auto animate-fade-in-up">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {generatedCode && (
           <DashboardCard title={t('yourWebsite')} icon={<EyeIcon className="w-7 h-7" />}>
            <div className="relative w-full h-48 bg-gray-200 rounded-lg overflow-hidden border border-gray-300 group">
                <iframe
