...
vi.mock('@/features/generation/geminiService', () => ({
  ...
  checkGeminiHealth: vi
    .fn()
    .mockResolvedValue({ ok: true, checked: true, retrying: false, message: '' }),
}));
    ...
    <div>
      ...
      <button
        onClick={() => {
          ...
          context.setUserPhone('1234567890');
          context.setServices('Fresh bakery goods and cakes');
          context.setPrompt('Best bakery in town');
          context.setSelectedPalette('Modern');
        }}
